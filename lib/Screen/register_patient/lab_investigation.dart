...
class _LabInvestigationsState extends State<LabInvestigations> {
  ...
  void initState() {
    ...
    // LabInvestigationController.i.updateGrandTotal(
    //     LabInvestigationController.i.discountamount.text, TypeValue.toString());
                          ...
                          children: [
                            ...
                            SizedBox(
                                ...
                                child: AuthTextField(
                                  ...
                                  function: (String a) {
                                    discount = a;
                                    cont.updateGrandTotal(TypeValue.toString());
                                    setState(() {});
                                  },
                                )),
                            SizedBox(
                        ...
                        Column(
                          ...
                          children: [
                            Align(
                              alignment: Alignment.centerRight,
                              child: Text(
                                'Discount: ${cont.discountamount.text == "" ? '0.0' : (TypeValue == 'Percentage' ? '$discount%' : discount)}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyMedium
                                    ?.copyWith(
                            ...
                            Align(
                              alignment: Alignment.centerRight,
                              child: Text(
                                '${'Grand Total'.tr} : ${cont.discountamount.text == "0.0" || cont.discountamount.text.isEmpty || cont.discountamount.text == "0" ? cont.totalprice : cont.grandprice}',
                                style: Theme.of(context)
                                    .textTheme
                                    .bodyMedium
                                    ?.copyWith(
                    ...
                    PrimaryButton(
                        ...
                        onPressed: () async {
                          ...
                          if (cont.selectedLabValue == 0 &&
                              (AddressController.address == null ||
                                  AddressController.address == "")) {
                            ToastManager.showToast('Address Not Selected'.tr);
                          } else {
                            // bool? isLoggedin =
