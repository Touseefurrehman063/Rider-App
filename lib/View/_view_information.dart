...
class _ViewInformationState extends State<ViewInformation> {
  ...
  List<String> labsNameArray = ['Select Lab'];
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['Status'] != null &&
          ...
          List<String> selectedPayment = ['Payment Method'];
...
if(widget.user.status=="In Route")
  {
    _getPolylinesWithLocationforlab(_currentLatLng,LatLng(double.parse(widget.user.inroutelat.toString()??""),double.parse(widget.user.inroutelon.toString()??"")));
  }
        ...
        if (widget.user.status!.toString().trim().toLowerCase() != "pending") {
          ...
          if (widget.user.status!.toString() == "In Route") {
            ...
            _getPolylinesWithLocationforlab(
                _currentLatLng, LatLng(double.parse(widget.user.inroutelat.toString()),double.parse(widget.user.inroutelon.toString())));
          } else if(widget.user.status!.toString() == "Ride Started" || widget.user.status!.toString() == "Booked"  ) {
  ...
  Future<void> getsampleapi() async {
    ...
    samplebody bdody = samplebody(
      ...
      userId: widget.empId,
      branchLocationId: widget.user.branchlocationid,
      labNo: checkinreponselist.last.labNo.toString().split(';').first,
      // visitNo: checkinreponselist.last.visitNo,
      // appointmentNo: widget.user.LabNo,
      appointmentNo: widget.user.LabNo,
      price: lst1.last.charges,
    );
  ...
  Future<void> samplecollectionapi() async {
    ...
    for (var val in samplecollectionresponselst) {
      listlabsamplelst.add(ListLabServiceDataDetail(
          ...
          roleId: val.roleId ?? "",
          isInPatient: true,
          patientVisitNo: checkinreponselist.last.visitNo,
          subserviceName: val.subServiceName ?? "",
          prescribedbyName: val.prescribedBy ?? "",
          charges: lst1.last.charges,
          prescribedQuantity: 6,
          totalCharges: lst1.last.totalCharges ?? "",
    ...
    samplecollectedModel bdody = samplecollectedModel(
        ...
        doctorId: "",
        subServiceId: lst1.first.subServiceId ?? "",
        ...
        autoNumberGenerationLabelText:
            samplecollectionresponselst.last.autoNumberGenerationLabelText ??
                "",
        sessionUserId: widget.user.empId);
      ...
      builder: (BuildContext context) {
        return MediaQuery(
            ...
            child: CupertinoAlertDialog(
              ...
              content: const Text('Do you want to start Ride?'),
              actions: [
                Padding(
      ...
      builder: (BuildContext context) {
        return MediaQuery(
            ...
            child: CupertinoAlertDialog(
              ...
              content: const Text('Are You Arrived at Patient Location?'),
              actions: [
                Padding(
                  padding: const EdgeInsets.only(left: 20.0),
                  child: Row(
                                ...
                                title: Column(
                                  ...
                                  children: [
                                              ...
                                              Flexible(
                                                child: Text(
                                                  ...
                                                  overflow: TextOverflow
                                                      .ellipsis, // Add this line to handle long names
                                                  maxLines:
                                                      1, // Add this line to ensure only one line is displayed
                                                ),
                                              ),
                                            ],
                                          ),
                                                            ...
                                                            CupertinoButton(
                                                              ...
                                                              onPressed:
                                                                ...
                                                                Navigator.of(
                                                                    ...
                                                                    {
                                                                        Showtoaster().classtoaster("Please Enter remarks");
                                                              ...
                                                              onPressed:
                                                                ...
                                                                Navigator.of(
                                                                    ...
                                                                    .pop();
                                                                        ...
                                                                        Showtoaster().classtoaster("Please Enter Remarks First");
                                      ...
                                      InkWell(
                                        ...
                                        child: Padding(
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: 
                                            widget.user.paymentstatusname!="Success"? Container(
                                    ...
                                    if (widget.user.status == "Ride Arrived")
                                      SizedBox(
                                          child: 
                                          widget.user.paymentstatusname!="Success"?const Text(
                                        "Discount:",
                                      ...
                                      SizedBox(
                                        ...
                                        child: Row(
                                          mainAxisAlignment:
                                              MainAxisAlignment.center,
                                          children: [
                                           widget.user.paymentstatusname!="Success"? Row(
                                              mainAxisAlignment:
                                        ...
                                        child: ElevatedButton(
                                          onPressed: () async {
                                            if (selectedLabsName == null) {
                                              Showtoaster().classtoaster('Please select a Lab');
                                    ...
                                    if (widget.user.status == "Ride Arrived")
                                     ...
                                     SizedBox(
                                          width: MediaQuery.of(context)
                                              ...
                                              ,
                                          child: Text(
                                            "Payment Status: ${widget.user.paymentstatusname??" Unpaid"} ",
                                            style: GoogleFonts.poppins(
                                              fontSize: 12,
                                              fontWeight: FontWeight.bold,
                                              color: Colors.white,
