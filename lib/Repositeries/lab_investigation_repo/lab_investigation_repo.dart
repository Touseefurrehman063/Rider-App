  ...
  updatebookLabInvestigation(
    ...
    for (int i = 0; i < cont.selectedLabTests.length; i++) {
      ...
      jsonList.add({
        ...
        "Price": list.price / qty,
        'TypeBit': list.typebit,
    ...
    try {
      ...
      if (result.statusCode == 200) {
        ...
        if (response['Id'] == 2) {
          ...
          //   empId: "",
          //   start: "",
          //   StartDate: LabInvestigationController.i.date,
          //   EndDate: "",
          //   patientName: LabInvestigationController.i.username,
          //   test: LabInvestigationController.i.test,
          //   address: LabInvestigationController.i.Address,
          //   status: LabInvestigationController.i.status1,
          //   patientid: LabInvestigationController.i.patientid,
          //   message: "",
          //   ride_CancelRemarks: "",
          //   appointmentno: "",
          //   branchlocationid: LabInvestigationController.i.branchid,
          //   Patientappoinmentid: "",
          //   LabNo: LabInvestigationController.i.appointment,
          //   price: LabInvestigationController.i.totalprice.toString(),
          //   url: "",
          //   imagePath: "",
          //   cNICNumber: "",
          //   latitude: "",
          ...
          //   token: "",
          //   labTestChallanNo: "",
          //   time: LabInvestigationController.i.time,
          //   Labid: "",
          //   inroutelat: "",
          //   inroutelon: "",
          //   paymentstatusname: LabInvestigationController.i.paymentstatus,
          //   paymentstatusvalue: cont.selectedstatusvalue,
          //   visitno: LabInvestigationController.i.visitno,
          //   PatientServiceAppointmentId:
          //       LabInvestigationController.i.patientstatusid,
          //   subserviceid: list?.id,
          //   StatusValue: "",
          //   MRNo: "",
          //   LabName: "",
          ...
          //   amount: "",
          //   discounttype: "",
          //   discount: LabInvestigationController.i.discount1,
          //   totalamount: "",
          //   iscombine: "",
          //   refNo: "",
          //   id: "",
