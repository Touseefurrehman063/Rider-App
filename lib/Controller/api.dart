...
getlabtest() async {
  var bdody = {"LabId": "", "Token": "44717866-70BA-4223-8F97-45286B2FD599"};
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (data['Status'] != null &&
          data['Status'] == 1 &&
          data['Data'] != null) {
        familycontroller.i.appointments =
...
checkinapi(String labno, String branchlocationid) async {
  ...
  if (response.statusCode == 200) {
    ...
    if (status != null && status == 1 && detail != null) {
      familycontroller.i.checkinreponselist
          .add(checkinresponse.fromJson(detail));
