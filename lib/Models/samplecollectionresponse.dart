class samplecollectionresponse {
  ...
  Map<String, dynamic> toJson() {
    ...
    data['PatientLabStatusId'] = patientLabStatusId;
    ...
    data['LabCurrentStatus'] = labCurrentStatus;
    data['OutSourcedBranchName'] = outSourcedBranchName;
    data['OutsourcedBranchId'] = outsourcedBranchId;
    data['SubDepartmentId'] = subDepartmentId;
    data['DepartmentId'] = departmentId;
    data['DesignationId'] = designationId;
    data['RoleId'] = roleId;
    data['CallBackCount'] = callBackCount;
    data['TotalAmount'] = totalAmount;
    data['PaidAmount'] = paidAmount;
    data['Discount'] = discount;
    data['DueAmount'] = dueAmount;
    data['SpecimenQuantity'] = specimenQuantity;
    data['BarCodeIndicators'] = barCodeIndicators;
    data['PrescribedByDepartmentId'] = prescribedByDepartmentId;
    data['PrescribedBySubDepartmentId'] = prescribedBySubDepartmentId;
    data['Payments'] = payments;
    data['Sampling'] = sampling;
    data['PendingBatch'] = pendingBatch;
    data['DispatchedBatch'] = dispatchedBatch;
    data['ResultEntry'] = resultEntry;
    data['Verification'] = verification;
    data['Verified'] = verified;
    data['IsOutsideSample'] = isOutsideSample;
    data['IsOnePagerReport'] = isOnePagerReport;
    data['IsConfidential'] = isConfidential;
    data['IsDepartmentPrintOnly'] = isDepartmentPrintOnly;
    data['CanPrintConfidential'] = canPrintConfidential;
    data['CanPrintDepartmentOnly'] = canPrintDepartmentOnly;
    data['CellNumber'] = cellNumber;
    data['Address'] = address;
    data['Age'] = age;
    data['Gender'] = gender;
    data['DateOfBirth'] = dateOfBirth;
    data['CallBackComments'] = callBackComments;
    data['IdentityNo'] = identityNo;
    data['AttributeResult'] = attributeResult;
    ...
    data['DisplaySampleCollectionDateTime'] =
        displaySampleCollectionDateTime;
    data['DisplayReportedOn'] = displayReportedOn;
    ...
    data['VaccinationStatusName'] = vaccinationStatusName;
    data['VaccineId'] = vaccineId;
    data['VaccineName'] = vaccineName;
    data['VaccinationDate'] = vaccinationDate;
    data['VaccinationRemarks'] = vaccinationRemarks;
    data['ConsumptionItem'] = consumptionItem;
    data['ManualCode'] = manualCode;
    data['IsResultEnteredByMachine'] = isResultEnteredByMachine;
    data['SubDepartmentManualCodeString'] = subDepartmentManualCodeString;
    data['SpecimenCode'] = specimenCode;
    data['CreatedByName'] = createdByName;
    data['CallBackRemarks'] = callBackRemarks;
    data['ActionByName'] = actionByName;
    data['ServiceReportType'] = serviceReportType;
    data['CreatedOn'] = createdOn;
    data['IsLabReportOnHold'] = isLabReportOnHold;
    data['ReportVisibilityType'] = reportVisibilityType;
    data['PatientLabBookingSlipAttachmentPath'] =
        patientLabBookingSlipAttachmentPath;
    data['SampleCollectionStickerCount'] = sampleCollectionStickerCount;
    data['ForwardToConsultantRemarks'] = forwardToConsultantRemarks;
    data['SampleReceivedFromRemarks'] = sampleReceivedFromRemarks;
    data['TokenNumber'] = tokenNumber;
    data['RoomName'] = roomName;
    data['RoomId'] = roomId;
    data['TokenStatus'] = tokenStatus;
    data['TokenCallTime'] = tokenCallTime;
    data['InfoCertificationType'] = infoCertificationType;
    data['AssignToForVerificationById'] = assignToForVerificationById;
    data['AssignToForConsultantVerificationById'] =
        assignToForConsultantVerificationById;
    data['HoldingRemarks'] = holdingRemarks;
    ...
    data['AutoNumberGeneratedValue'] = autoNumberGeneratedValue;
    data['LabExecutionDateTime'] = labExecutionDateTime;
    data['IsReportVerificationRequiredByConsultant'] =
        isReportVerificationRequiredByConsultant;
    data['IsReportVerifiedByConsultant'] = isReportVerifiedByConsultant;
    data['IsProvisionalReportsPrintable'] = isProvisionalReportsPrintable;
    data['PatientEmail'] = patientEmail;
    data['BranchLocationName'] = branchLocationName;
    data['SpecimenTestMethodId'] = specimenTestMethodId;
    data['SampleReceivedDateTime'] = sampleReceivedDateTime;
    data['ReportEnteredDateTime'] = reportEnteredDateTime;
